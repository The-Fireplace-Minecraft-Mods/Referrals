...
public class ReferralsLanguageMap {
    ...
    private static final ReferralsLanguageMap instance = new ReferralsLanguageMap(Config.getInstance().locale);
    private final Map<String, String> languageList = Maps.newHashMap();

    ReferralsLanguageMap(String locale) {
        InputStream inputstream = ReferralsLanguageMap.class.getResourceAsStream("/assets/referrals/lang/" + locale + ".lang");
    ...
    private static void inject(ReferralsLanguageMap inst, InputStream inputstream) {
    ...
    static ReferralsLanguageMap getInstance() {
        return instance;
    }
